 ...
 * Reads/writes cookies via Next's headers() helper.
 */
      ...
      cookies: {
        ...
        setAll(cookiesToSet) {
          try {
            ...
            // Middleware should be in charge of refreshing the session.
          }
        },
      },
    }
...
/**
 * Supabase admin client for server-side mutations that bypass RLS.
